...
/**
  * This is an event sourced entity. It has a state, [[PetState]], which
...
class PetEntity extends PersistentEntity {
  ...
  /**
    ...
    */
  override def initialState: PetState = PetState("Hello", LocalDateTime.now.toString)
  ...
  override def behavior: Behavior = {
    case PetState(message, _) => Actions().onCommand[UseGreetingMessage, Done] {
      ...
      case (GreetingMessageChanged(newMessage), state) =>
        ...
        // the event.
        PetState(newMessage, LocalDateTime.now().toString)
...
/**
  ...
  */
case class PetState(message: String, timestamp: String)
...
/**
  * This interface defines all the events that the PetEntity supports.
  */
sealed trait PetEvent extends AggregateEvent[PetEvent] {
  def aggregateTag = PetEvent.Tag
}
...
/**
  ...
  */
case class GreetingMessageChanged(message: String) extends PetEvent
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends PetCommand[Done]
...
/**
  ...
  * person.
  */
case class Hello(name: String) extends PetCommand[String]
